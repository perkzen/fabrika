...
const configure = (presenter: Presenter) =>
  Effect.gen(function* () {
    ...
    // for code it never wrote. One structured call proposes the five
    ...
    yield* say("reading the repo: base branch, install command, the checks CI enforces, where the source lives, and the review bot.");
